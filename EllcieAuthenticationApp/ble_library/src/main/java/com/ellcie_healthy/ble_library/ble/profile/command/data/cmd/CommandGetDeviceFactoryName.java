...
public class CommandGetDeviceFactoryName extends CommandResponse {
    private static final int MIN_DEVICE_NAME_SIZE = 0;
    private static final int MAX_DEVICE_NAME_SIZE = 16;
    private String mName = null;

    public CommandGetDeviceFactoryName() {
        super(CommandCode.COMMAND_GET_DEVICE_NAME_FACTORY, MIN_DEVICE_NAME_SIZE, MAX_DEVICE_NAME_SIZE);
    }
