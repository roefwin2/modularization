...
public class CommandGetBleFwVersion extends CommandResponse {
    private static final int MIN_VERSION_SIZE = 5;
    private static final int MAX_VERSION_SIZE = 16;
    private String mVersion = null;

    public CommandGetBleFwVersion() {
        super(CommandCode.COMMAND_GET_DEVICE_BT_FIRWMARE_VERSION, MIN_VERSION_SIZE, MAX_VERSION_SIZE);
    }
